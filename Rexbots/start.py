...
# Safety cap: max number of messages a single batch link range can request
MAX_BATCH_IDS_FREE    = 50
MAX_BATCH_IDS_PREMIUM = 200
...
async def save(client: Client, message: Message):
    ...
    if toID > fromID:
        ...
        max_ids = MAX_BATCH_IDS_PREMIUM if is_premium else MAX_BATCH_IDS_FREE
